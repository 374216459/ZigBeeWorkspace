 ...
 *
 * @param errorCode one of the 2 error codes that our stack can handle:
...
/** @brief Sets the routing shortcut threshold to directly use a neighbour instead of
 * performing routing.
 *
 * @param costThresh the routing shortcut value that should be used to directly use a neighbour
...
/** @brief Get the routing shortcut threshold used to seperate between directly using a neighbour
 * vs. performing routing.
 *
 * @return the routingShortcutThresh which takes one of the following values: 1, 3, 5, 7
 *
 */
