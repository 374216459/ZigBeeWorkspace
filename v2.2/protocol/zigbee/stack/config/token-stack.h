...
// The Simulated EEPROM and NVM3 unit tests define all of their own tokens.
...
#elif defined(EZSP_HOST) && defined(EMBER_AF_API_TOKEN)
...
//Bits 0 and 1 are currently in use. Bits 2-16 are reserved.
...
//The Simulated EEPROM and NVM3 unit tests define all of their tokens via the
