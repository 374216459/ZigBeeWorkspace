 ...
 * The maximum allowed value is 26.  End device children are kept
...
/** @brief The maximum number broadcasts during a single broadcast timeout
 ...
 * table size as it affects timing of the broadcasts as well as number of
...
/** @brief Timeout (secs) to restore the gpd incoming security frame counter in the flash (0 being never)
 */
...
/** @brief Max Table size to restore the gpd incoming security frame counter in the flash (being either 0 or EMBER_GP_PROXY_TABLE_SIZE)
 */
